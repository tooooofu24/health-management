...
@section('title', '管理者画面 - 部活別ページ')
@section('nav_title', "部活別ページ 『{$club->name}』")
@section('content')
                ...
                <table class="table table-hover table-centered border-0">
                    <thead class="table-secondary border-0 rounded">
                        <tr class="rounded">
                            ...
                            <th scope="col" class="border-0 text-center text-nowrap" style="min-width: 15rem;">備考</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle border-0" style="font-size: 0.8rem;">{{ optional($student->answer)->comment }}</td>
